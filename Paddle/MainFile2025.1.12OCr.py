...
font = ImageFont.truetype("simfang.ttf", 23)
for (start, end, text) in merged_list:
    draw.rectangle([start[0], start[1], end[0], end[1]], outline="red", width=1)
    draw.text((start[0]+200, start[1]), text, fill=(0, 0, 255), font=font)  # 坐标、文本内容、颜色、字体
