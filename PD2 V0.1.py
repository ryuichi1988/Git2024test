...
while True:
    ...
    # 工数集計表を開く
    try:
        PrimeDai2MeiBoFile = openpyxl.load_workbook(r"C:\1\PD2\プライム第二出勤者名簿.xlsx")
    ...
    # NEWマスターファイルを開く (10月分)
    PD2kosuEXCEL = openpyxl.load_workbook(r"C:\1\PD2\PD2工数.xlsx")
    ...
    PrimeDai2MeiBoFile.save(r"C:\1\PD2\プライム第二出勤者名簿.xlsx".format(SAGYOUDETA))
    PD2kosuEXCEL.save(r"C:\1\PD2\PD2工数.xlsx".format(dcmonth))